...
type DevTreeInputProps = {
    ...
    handelEnableLink: (socialNetwork: string) => void
}

export default function DevTreeInput({ item, handelUrlChange, handelEnableLink }: DevTreeInputProps) {
    return (
        <div className="bg-white shadow-sm p-5 flex items-center gap-3">
            ...
            <Switch
                ...
                onChange={() => handelEnableLink(item.name)}
